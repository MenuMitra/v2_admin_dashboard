...
import { FiUser, FiMail, FiPhone, FiMapPin, FiCalendar, FiCreditCard, FiArrowLeft, FiSave, FiAlertCircle, FiCheck, FiAlertTriangle } from 'react-icons/fi';
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600">Update information for {formData.name}</p>
        </div>
