...
export const queryKeys = {
  ...
  staff: {
    all: ["staff"],
    list: (outletId) => [...queryKeys.staff.all, "list", outletId],
    detail: (outletId, userId) => [
      ...queryKeys.staff.all,
      "detail",
      outletId,
    ...
    bulk: (outletId) => [...queryKeys.staff.all, "bulk", outletId],
  },
  ...
  captains: {
    ...
    details: (outletId, userId) => [
      ...queryKeys.captains.root,
      "details",
      outletId,
      userId,
    ],
