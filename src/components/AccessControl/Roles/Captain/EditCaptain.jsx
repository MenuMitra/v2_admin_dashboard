...
function EditCaptain() {
  ...
  const fetchCaptainDetails = async () => {
    try {
      ...
      const errorMsg =
        err.response?.data?.msg || "Failed to fetch captain details";
      ...
      await toastController.promise(
        ...
        ),
        {
          ...
          error: (err) =>
            ...
            "An error occurred while updating captain",
        }
      );
  ...
  const filteredFunctionalities = (
    Array.isArray(availableFunctionalities) ? availableFunctionalities : []
  ).filter((func) =>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="font-medium text-gray-900">
                          {captainData.functionality_ids.length}{" "}
                      ...
                      {filteredFunctionalities.map((func) => (
                        <div
                          ...
                          className={`
                            ...
                            ${
                              captainData.functionality_ids.includes(
                          ...
                          onClick={() => {
                            const newIds =
                              captainData.functionality_ids.includes(
                                ...
                                ? captainData.functionality_ids.filter(
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <input
                              type="checkbox"
                              checked={captainData.functionality_ids.includes(
                                func.functionality_id
                              )}
                              onChange={(e) => {
                                e.stopPropagation();
