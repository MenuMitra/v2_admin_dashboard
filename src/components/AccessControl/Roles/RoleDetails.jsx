        ...
        actionButtons={
          <>
            <button
              ...
              className="flex w-full justify-center rounded-3xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs hover:border-gray-300 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:hover:text-gray-300 sm:w-auto"
            >
              Cancel
            </button>
            <button
              ...
              className="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-3xl bg-error-500 shadow-theme-xs hover:bg-error-600 sm:w-auto"
            >
              Delete Customer
            </button>
          </>
