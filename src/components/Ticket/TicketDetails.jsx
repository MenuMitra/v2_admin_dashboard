        ...
        <div className="p-6">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 mb-4 h-96 overflow-y-auto">
            {conversations.reduce((messageGroups, conv, index) => {
              ...
              if (
                index === 0 ||
                messageDate !==
                  formatMessageDate(conversations[index - 1].created_on)
              ) {
                messageGroups.push(
                  <div
                    key={`date-${conv.ticket_chat_id}`}
              ...
              messageGroups.push(
                ...
                >
                  ...
                  <div
                    className={`text-xs text-gray-500 dark:text-gray-400 mt-1 opacity-0 group-hover:opacity-100 transition-opacity`}
                  >
                    {conv.user_name}
                  </div>
                </div>
          ...
          <form onSubmit={handleSendMessage} className="flex gap-2">
            ...
            <button
              type="submit"
              disabled={
                loading || !message.trim() || ticket.status === "closed"
              }
